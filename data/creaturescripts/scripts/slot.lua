...
for i=1,300 do
  ...
  setConditionParam(conditionSHI[i], CONDITION_PARAM_SUBID, 53)
  ...
  setConditionParam(conditionDIST[i], CONDITION_PARAM_SUBID, 54)
...
local cid = player:getId()
  addEvent(chk,700,cid,loadSet(cid))
  return true
end
