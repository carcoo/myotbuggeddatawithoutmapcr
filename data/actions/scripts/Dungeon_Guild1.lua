local config = {
    ...
    level = 300000,                            -- Level Necessary.
    dungeonPos = Position(715, 364, 7),    -- Dungeon Pos.
    needPos = {
        [1] = Position(1074, 859, 7),       -- Position (where the player will click on the lever) and back position.
        [2] = Position(1072, 859, 7),
        [3] = Position(1075, 857, 7),
        [4] = Position(1075, 861, 7)
    },
    fromPos = {x = 564, y = 343, z = 7},   -- Position /\ < from the dungeon
    toPos = {x = 862, y = 593, z = 7},     -- Position \/ > from the dungeon
 
    Storagetime = 42893,                    -- Storage Time.
    StorageDay = 42894,                     -- Storage Day.
