...
local missions = {
   [1] = {
     ...
     message = "Great, lets see what Monaki's fighters can do for us, I need",
...
function creatureSayCallback(cid, type, msg)
	 ...
	 if player:getStorageValue(48295) == 1 then
         if player:getStorageValue(storage) == -1 then
             selfSay("Okay, are you ready to mine 500 iron ore for me?", cid)
         ...
         elseif x then
		 	...
		 	selfSay("Go and talk with Monaki first there is no time to waste!", cid)
				  npcHandler:releaseFocus(cid)
				  end
         ...
         elseif x then
             ...
             if amount == #imtable then
                 ...
                 if x then
                     ...
                     selfSay("Well done! You did a great job on your mission, you really desreve taking this pendant go back to Monaki he will be excited its a long time since nobody brought him my special Golden scorpion pendant", cid)
                 end
             else
                 local n = 0
                 for i = 1, #imtable do
                 ...
                 selfSay(x.items and "You don't have all items, you still need to get "..text..", is it that hard? hah." or "You didn't kill Abyssador, told you its not easy to face him "..text..".", cid)
             end
         end
