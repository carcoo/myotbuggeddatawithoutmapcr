...
enum ConditionParam_t {
	...
	CONDITION_PARAM_SKILL_CRITICAL_HIT_CHANCEPERCENT = 54,
	CONDITION_PARAM_SKILL_CRITICAL_HIT_DAMAGEPERCENT = 55,
	CONDITION_PARAM_SKILL_LIFE_LEECH_CHANCEPERCENT = 56,
	CONDITION_PARAM_SKILL_LIFE_LEECH_AMOUNTPERCENT = 57,
	CONDITION_PARAM_SKILL_MANA_LEECH_CHANCEPERCENT = 58,
	CONDITION_PARAM_SKILL_MANA_LEECH_AMOUNTPERCENT = 59,
};
