...
const std::unordered_map<std::string, ItemParseAttributes_t> ItemParseAttributesMap = {
	...
	{"skillstatcriticalchance", ITEM_PARSE_CRITICALHITCHANCE},
	{"skillstatcriticaldamage", ITEM_PARSE_CRITICALHITAMOUNT},
	{"skillstatlifeleechchance", ITEM_PARSE_HITPOINTSLEECHCHANCE},
	{"skillstatlifeleechdamage", ITEM_PARSE_HITPOINTSLEECHAMOUNT},
	{"skillstatmanaleechchance", ITEM_PARSE_MANAPOINTSLEECHCHANCE},
	{"skillstatmanaleechdamage", ITEM_PARSE_MANAPOINTSLEECHAMOUNT},
		...
		if (parseAttribute != ItemParseAttributesMap.end()) {
			...
			switch (parseType) {
				...
				case ITEM_PARSE_CRITICALHITCHANCE: {
					abilities.skills[SKILL_CRITICAL_HIT_CHANCE] = pugi::cast<int32_t>(valueAttribute.value());
					break;
				}
				case ITEM_PARSE_CRITICALHITAMOUNT: {
					abilities.skills[SKILL_CRITICAL_HIT_DAMAGE] = pugi::cast<int32_t>(valueAttribute.value());
					break;
				}
				case ITEM_PARSE_HITPOINTSLEECHCHANCE: {
					abilities.skills[SKILL_LIFE_LEECH_CHANCE] = pugi::cast<int32_t>(valueAttribute.value());
					break;
				}
				case ITEM_PARSE_HITPOINTSLEECHAMOUNT: {
					abilities.skills[SKILL_LIFE_LEECH_AMOUNT] = pugi::cast<int32_t>(valueAttribute.value());
					break;
				}
				case ITEM_PARSE_MANAPOINTSLEECHCHANCE: {
					abilities.skills[SKILL_MANA_LEECH_CHANCE] = pugi::cast<int32_t>(valueAttribute.value());
					break;
				}
				case ITEM_PARSE_MANAPOINTSLEECHAMOUNT: {
					abilities.skills[SKILL_MANA_LEECH_AMOUNT] = pugi::cast<int32_t>(valueAttribute.value());
					break;
				}
